...
function UserMenu() {
  ...
  const pinJSONToIPFS = async () => {
    ...
    try {
      ...
      setTokenURI(`https://gateway.pinata.cloud/ipfs/${ipfsHash2}`);
      console.log(res.data);
      document.getElementById('tokenUrl').href = `https://gateway.pinata.cloud/ipfs/${ipfsHash2}`; // Update link
      document.getElementById('tokenUrl').textContent = `View your file on IPFS`;
    } catch (error) {
      console.log(error);
    }
  }
      ...
      <div className='usermenu-section'>
        ...
        <div className='usermenu-steps'>
          ...
          <div className="appointment-form-section">
            ...
            <p className="usermenu-success-message" style={{ display: isSubmitted ? "block" : "none" }}>User details has been submitted successfully.</p>
          ...
          <label>First download Excel file and fill details : <a href="https://docs.google.com/spreadsheets/d/1veQ1I6aKpgGrdk9WMwTjIUtFShjpe4lo/edit?usp=sharing&ouid=116763084471557234093&rtpof=true&sd=true" target="_blank" >Excel File</a></label>
          <button>
            <a href="https://colab.research.google.com/drive/1YeL6HCaN9otUxUoUBKtIJ6mvMbKDxmd7?usp=sharing" target="_blank">Create Steg-Aadhar</a>
          </button>
          <br />
          <br />
          ...
          <form>
            <input className='fileinput' type='file' id="fileInput" onChange={(e) => setFile(e.target.files[0])} /><br /><br />
            <button type='submit' onClick={pinFileToIPFS} disabled={!file}>Upload</button>
          </form>
          <br />
          <label><a id="fileUrl" href={fileUrl} target="_blank">You can view file once it is uploaded!</a></label>
          <br />

          <p className='usermenu-title'>Upload Metadata JSON file to IPFS:</p>
          <button type='submit' onClick={pinJSONToIPFS} disabled={!fileUrl}>Upload JSON File</button><br /><br />
          <label><a id="tokenUrl" href={tokenURI} target="_blank">You can view file once it is uploaded!</a></label>
          <br />
          <br />
          ...
          <div className="App">
            ...
            {transactionHash && (
              <label>
                <br />
                View Transaction on Etherscan and obtain the Contract Address and Token ID<br /><br />
